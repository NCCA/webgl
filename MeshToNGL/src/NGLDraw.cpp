...
NGLDraw::NGLDraw()
{
  ...
  // spelling out 20+ single postprocessing flags here.
	...
	m_scene = aiImportFile("/models/bobWalk.dae",
...
void NGLDraw::buildVAOFromScene()
{
...
void NGLDraw::recurseScene(const aiScene *sc, const aiNode *nd,const ngl::Mat4 &_parentTx)
{
