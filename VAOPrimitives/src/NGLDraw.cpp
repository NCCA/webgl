...
NGLDraw::NGLDraw()
{
 ...
 ngl::VAOPrimitives *prim=ngl::VAOPrimitives::instance();
  ...
  prim->createCapsule("capsule",1.0,2.0,20);
  m_lightAngle=0.0f;
...
void NGLDraw::draw()
{
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(-3,0.0,0.0);
    loadMatricesToShader();
    prim->draw("sphere");
  } // and before a pop
  m_transformStack.popTransform();
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(0.0,0.0,3.0);
    loadMatricesToShader();
    prim->draw("cube");
  } // and before a pop
  m_transformStack.popTransform();
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(-3.0,0.0,3.0);
    loadMatricesToShader();
    prim->draw("torus");
  } // and before a pop
  m_transformStack.popTransform();
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(3.0,0.5,3.0);
    loadMatricesToShader();
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(0.0,0.5,-6.0);
    loadMatricesToShader();
    prim->draw("football");
  } // and before a pop
  m_transformStack.popTransform();
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(-3.0,0.5,-6.0);
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(-1.0,0,1.0);
    m_transformStack.setScale(0.2,0.2,0.2);
  ...
  m_transformStack.pushTransform();
  {
    m_transformStack.setPosition(0.0,-0.5,0.0);
    loadMatricesToShader();
    prim->draw("plane");
  } // and before a pop
  m_transformStack.popTransform();
